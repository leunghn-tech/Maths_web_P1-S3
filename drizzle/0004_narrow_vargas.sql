...
ALTER TABLE `users` ADD `recoveryCodeHash` varchar(255);--> statement-breakpoint
...
CREATE INDEX `password_reset_tokens_user_idx` ON `password_reset_tokens` (`userId`,`createdAt`);--> statement-breakpoint
