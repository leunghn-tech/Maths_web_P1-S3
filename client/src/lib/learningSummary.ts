...
export type LearningGrade = "P1" | "P2" | "P3" | "P4" | "P5" | "P6" | "S1" | "S2" | "S3";
...
const curriculumTotals: Record<LearningGrade, Record<LearningDomain, number>> = {
  P1: { "數與代數": 4, "度量": 2, "圖形與空間": 3, "數據處理": 1 }, P2: { "數與代數": 4, "度量": 3, "圖形與空間": 3, "數據處理": 1 }, P3: { "數與代數": 3, "度量": 3, "圖形與空間": 3, "數據處理": 2 }, P4: { "數與代數": 4, "度量": 2, "圖形與空間": 3, "數據處理": 1 }, P5: { "數與代數": 3, "度量": 2, "圖形與空間": 3, "數據處理": 2 }, P6: { "數與代數": 4, "度量": 3, "圖形與空間": 2, "數據處理": 2 }, S1: { "數與代數": 7, "度量": 2, "圖形與空間": 6, "數據處理": 1 }, S2: { "數與代數": 6, "度量": 0, "圖形與空間": 7, "數據處理": 1 }, S3: { "數與代數": 4, "度量": 0, "圖形與空間": 4, "數據處理": 2 },
};
const domainOrder: LearningDomain[] = ["數與代數", "度量", "圖形與空間", "數據處理"];

function getGrade(key: string): LearningGrade | null { const match = key.toUpperCase().match(/^(P[1-6]|S[1-3])-/); return match ? match[1] as LearningGrade : null; }
