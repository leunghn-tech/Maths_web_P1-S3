...
export default function P2Practice() {
  ...
  const nextQuestion = () => {
    if (currentIndex === activeIndices.length - 1) {
      setFinished(true);
      if (!reviewMode) { markPracticeCompleted(`p2-${mode}`); setDailyProgress(recordDailyPractice(`p2-${mode}`)); }
