...
const starPractices: StarPractice[] = [
  ...
  { key: "p3-mixed-steps", grade: "P3", title: "四則步驟", detail: "括號次序", href: "/practice/p3-mixed-steps", accent: "#4f6eae" },
  { key: "p3-parallelogram-trapezium", grade: "P3", title: "平行四邊形", detail: "梯形分類", href: "/practice/p3-parallelogram-trapezium", accent: "#4f6eae" },
  { key: "p4-factors-multiples", grade: "P4", title: "因數與倍數", detail: "公因公倍", href: "/practice/p4-factors-multiples", accent: "#6c8b4c" },
  { key: "p4-fractions-visual", grade: "P4", title: "分數加減", detail: "圖形配對", href: "/practice/p4-fractions-visual", accent: "#6c8b4c" },
  { key: "p4-grid-area", grade: "P4", title: "周界面積", detail: "方格建構", href: "/practice/p4-grid-area", accent: "#6c8b4c" },
  ...
  { key: "p6-finance", grade: "P6", title: "百分應用", detail: "折扣利息", href: "/practice/p6-finance", accent: "#c8811e" },
  { key: "p6-solid-volume", grade: "P6", title: "立體截面", detail: "圓柱排水", href: "/practice/p6-solid-volume", accent: "#4f6eae" },
  { key: "p6-statistics", grade: "P6", title: "統計趨勢", detail: "平均中位", href: "/practice/p6-statistics", accent: "#7c6cb0" },
  { key: "p6-water-3d", grade: "P6", title: "3D 排水法", detail: "水位變化", href: "/practice/p6-water-3d", accent: "#4f9fc1" },
  { key: "p6-pie-drag", grade: "P6", title: "圓形圖製作", detail: "拖曳扇形", href: "/practice/p6-pie-drag", accent: "#f6be5d" },
  { key: "p6-equation-steps", grade: "P6", title: "方程步驟", detail: "逐步填答", href: "/practice/p6-equation-steps", accent: "#f05a3c" },
  { key: "p6-circle-lab", grade: "P6", title: "圓形工房", detail: "圓周面積", href: "/practice/p6-circle-lab", accent: "#4f6eae" },
  { key: "p6-nets", grade: "P6", title: "立體展開圖", detail: "截面摺紙", href: "/practice/p6-nets", accent: "#6c8b4c" },
  { key: "p6-coordinate-lab", grade: "P6", title: "坐標定位", detail: "第一象限", href: "/practice/p6-coordinate-lab", accent: "#7c6cb0" },
  ...
  { key: "s1-directed", grade: "S1", title: "有向數", detail: "正負數線", href: "/practice/s1?topic=directed", accent: "#3867a7" },
  { key: "s1-algebra", grade: "S1", title: "代數初步", detail: "代數式", href: "/practice/s1?topic=algebra", accent: "#3867a7" },
  { key: "s1-equation", grade: "S1", title: "一元方程", detail: "解 x", href: "/practice/s1?topic=equation", accent: "#3867a7" },
  ...
  { key: "s2-indices", grade: "S2", title: "指數定律", detail: "次方運算", href: "/practice/s2?topic=indices", accent: "#7d5ea8" },
  { key: "s2-factor", grade: "S2", title: "因式分解", detail: "公因式", href: "/practice/s2?topic=factor", accent: "#7d5ea8" },
  { key: "s2-formula", grade: "S2", title: "公式主項", detail: "變更主項", href: "/practice/s2?topic=formula", accent: "#7d5ea8" },
  { key: "s2-simultaneous", grade: "S2", title: "聯立方程", detail: "代入消元", href: "/practice/s2?topic=simultaneous", accent: "#7d5ea8" },
