...
export default function Home() {
  ...
  const isGradeCompleted = (grade: string) => {
    if (grade === "P1") return ["p1-add-subtract", "p1-numbers", "p1-time", "p1-number-line", "p1-measure"].some((id) => completedPractices.includes(id));
