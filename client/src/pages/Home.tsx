...
export default function Home() {
  ...
  const isGradeCompleted = (grade: string) => {
    ...
    if (grade === "P2") return ["p2-numbers", "p2-number-line", "p2-money", "p2-time", "p2-multiply-visual", "p2-money-coins", "p2-directions", "p2-multiply", "p2-divide", "p2-mixed"].some((id) => completedPractices.includes(id));
