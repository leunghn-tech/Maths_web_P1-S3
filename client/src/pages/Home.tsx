...
export default function Home() {
  ...
  const isGradeCompleted = (grade: string) => {
    ...
    if (grade === "P2") return ["p2-numbers", "p2-number-line", "p2-money", "p2-time", "p2-multiply-visual", "p2-money-coins", "p2-directions", "p2-division", "p2-direction-route", "p2-array-builder", "p2-measure", "p2-angles", "p2-division-remainder", "p2-multiply", "p2-divide", "p2-mixed"].some((id) => completedPractices.includes(id));
