...
const starPractices: StarPractice[] = [
  ...
  { key: "s3-identity", grade: "S3", title: "恆等式", detail: "三大公式", href: "/practice/s3?topic=identity", accent: "#1f8378" },
  { key: "s3-inequality", grade: "S3", title: "一元不等式", detail: "數線範圍", href: "/practice/s3?topic=inequality", accent: "#1f8378" },
  { key: "s3-finance", grade: "S3", title: "複利折舊", detail: "百分應用", href: "/practice/s3?topic=finance", accent: "#1f8378" },
  { key: "s3-proof", grade: "S3", title: "幾何證明", detail: "三角形四心", href: "/practice/s3?topic=proof", accent: "#1f8378" },
  { key: "s3-trig", grade: "S3", title: "進階三角學", detail: "方位仰俯角", href: "/practice/s3?topic=trig", accent: "#1f8378" },
  ...
  { key: "s3-probability", grade: "S3", title: "概率", detail: "機會率", href: "/practice/s3?topic=probability", accent: "#1f8378" },
];
