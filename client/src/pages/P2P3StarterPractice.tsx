...
export const fractionLabel = (parts: number) => parts === 2 ? "一半" : "四分之一";
...
export default function P2P3StarterPractice() {
  ...
  const config = mode === "fraction"
    ? { grade: "P2", code: "P2.12", title: "分數初步", tag: "一半與四分之一", id: "p2-fractions-basic", icon: <Shapes />, sub: "把圖形平均分開，認識一半和四分之一。" }
  ...
  const answer = mode === "fraction" ? fractionLabel(part) : weight.a;
