...
export default function TeacherDashboard() {
  ...
  const [sort, setSort] = useState<StudentSort>("recentSync");
  ...
  const filteredStudents = useMemo(() => {
    ...
    return sortTeacherStudents(matching, sort);
