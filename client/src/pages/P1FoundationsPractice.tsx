...
const numberChoices = (answer: number) => shuffle(Array.from(new Set([answer, Math.max(1, answer - 1), Math.min(20, answer + 1), Math.max(1, answer - 2)])));
...
const pictographs: PictoTask[] = [
  ...
  { action: "make", title: "拖圖案做圖表", rows: [["🟡", "黃星", 1], ["🔵", "藍星", 3], ["🔴", "紅星", 2]], emoji: "🔵", label: "藍星", answer: 3 },
...
const station = {
  ...
  pictograph: { key: "p1-pictograph", code: "P1.08", title: "象形圖", subtitle: "看圖數一數，也拖圖案做圖表。", action: "一個圖形代表一個", hint: "每一個圖案就是 1 個，逐個數最清楚。", stamp: "DATA LAB", Icon: ChartColumnIncreasing },
} as const;
