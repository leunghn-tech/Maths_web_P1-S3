...
const hourQuestions: Question[] = [
  ...
  { prompt: "上午 9 時", answer: "09:00", options: ["09:00", "19:00", "12:00", "21:00"], hint: "上午的時間不用加 12。" }, { prompt: "下午 12 時", answer: "12:00", options: ["00:00", "12:00", "24:00", "22:00"], hint: "中午是 12:00。" },
  { prompt: "晚上 11 時", answer: "23:00", options: ["11:00", "21:00", "23:00", "01:00"], hint: "晚上 11 時加上 12 小時。" }, { prompt: "凌晨 1 時", answer: "01:00", options: ["01:00", "11:00", "13:00", "00:00"], hint: "凌晨屬於上午時段。" },
